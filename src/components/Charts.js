...
class Charts extends Component {
    ...
    render() {
        ...
        location = per_hundred.map(item => item.place.toString().bold());
        ...
        if (this.props.removal_data.length > 0 && per_hundred.length > 0) {
            ...
            for (var i = 0; i < per_hundred.length; i++) {
                ...
                for (var j = 0; j < this.props.removal_data.length; j++) {
                    if (per_hundred[i]) {
                        if (per_hundred[i].place == (this.props.removal_data)[j])
                            flag++;
                    }
        ...
        return (
            <div>
                ...
                <div >
                    <div style={{ width: '100%', background: '#dcdcdc', paddingBottom: '25px', paddingTop: '5px' }}>
                        <Typography id='heading_dash' style={{ marginLeft: window.innerWidth > 768 ? '40%' : '35%', color: 'black', marginTop: '25px', fontSize: window.innerWidth > 768 ? '35px' : '21px' }}>Data-Polling</Typography>
                    </div>
                    {
                    ...
                    }
                    {
                        ...
                        <div id='scr1' style={{ bottom: window.innerWidth > 768 ? '80%' : '85%', left: window.innerWidth > 768 ? '40%' : '10%', position: 'fixed', zIndex: window.innerWidth > 768 ? '20' : '1', fontSize: window.innerWidth > 768 ? '20px' : '18px', fontWeight: '400', fontFamily: 'Helvetica', color: 'black', backgroundColor: '#e88d14', padding: '5px', borderRadius: '5px' }}>{(this.props.bucket)}&nbsp;&nbsp;items fetched every&nbsp;&nbsp;{Number(this.props.freq) / 1000}&nbsp;&nbsp;seconds.</div>
                    }
                    {
                        this.props.status_check && location.length > 0 &&
                        <div id='scr2' style={{ bottom: window.innerWidth > 768 ? '75%' : '79%', left: window.innerWidth > 768 ? '45%' : '35%', position: 'fixed', zIndex: window.innerWidth > 768 ? '20' : '1', fontSize: '17px', fontWeight: '300', fontFamily: 'Helvetica', color: 'white', backgroundColor: 'green', padding: '3px', borderRadius: '5px' }}>Live data Plotting</div>
                    }
                    {
                        !this.props.status_check && location.length > 0 &&
...

                        {
                            ...
                            < div id='back_image1' style={{ padding: '10px', width: '100%', marginTop: window.innerWidth > 768 ? '7%' : '15%', textAlign: 'center' }}>
                                <Plot
                                    ...
                                    layout={{ width: window.innerWidth > 768 ? '100%' : 320, height: window.innerWidth > 768 ? '100%' : 320, title: window.innerWidth > 768 ? 'location'.bold() + ' vs ' + 'Time Plot'.bold() + ' - Bar Chart' : 'KoD vs Time'.bold() }}
                                />
                            </div>
                        }
                        {
                            ...
                            < div id='back_image1' style={{ padding: window.innerWidth > 768 ? '10px' : '2px', width: '100%', marginTop: window.innerWidth > 768 ? '7%' : '15%', textAlign: 'center' }}>
                                <Plot
                                    ...
                                    layout={{ width: window.innerWidth > 768 ? '100%' : 320, height: window.innerWidth > 768 ? '100%' : 320, title: window.innerWidth > 768 ? 'location'.bold() + ' vs ' + 'Time Plot'.bold() + ' - Scatter Chart' : 'KoD vs Time'.bold() }}
                                />
                            </div>
                        }
                        {
                            ...
                            < div id='back_image2' style={{ padding: '10px', width: '100%', marginTop: window.innerWidth > 768 ? '7%' : '15%', textAlign: 'center' }}>
                                <Plot
                                    ...
                                    layout={{ width: window.innerWidth > 768 ? '100%' : 320, height: window.innerWidth > 768 ? '100%' : 320, title: window.innerWidth > 768 ? 'location'.bold() + ' vs ' + 'T_reading Plot'.bold() + ' - Bar Chart' : 'KoD vs temp'.bold() }}
                                />
                            </div>
                        }
                        {
                            ...
                            < div id='back_image2' style={{ padding: '10px', width: '100%', marginTop: window.innerWidth > 768 ? '7%' : '15%', textAlign: 'center' }}>
                                <Plot
                                    ...
                                    layout={{ width: window.innerWidth > 768 ? '100%' : 320, height: window.innerWidth > 768 ? '100%' : 320, title: window.innerWidth > 768 ? 'location'.bold() + ' vs ' + 'T_reading Plot'.bold() + ' - Scatter Chart' : 'KoD vs temp'.bold() }}
                                />
                            </div>
                        }
                    </div>
